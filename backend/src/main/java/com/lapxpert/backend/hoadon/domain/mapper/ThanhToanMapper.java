...
import com.lapxpert.backend.hoadon.domain.dto.ThanhToanDto;
import com.lapxpert.backend.hoadon.domain.entity.ThanhToan;
import com.lapxpert.backend.nguoidung.domain.entity.NguoiDung; // For mapping NguoiDung to nguoiDungId
