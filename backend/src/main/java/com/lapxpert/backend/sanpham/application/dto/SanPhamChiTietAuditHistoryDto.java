...
/**
 * DTO for SanPhamChiTietAuditHistory entity.
 * Represents a single audit trail entry for product variant changes.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class SanPhamChiTietAuditHistoryDto implements Serializable {
