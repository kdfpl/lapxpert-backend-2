package com.lapxpert.backend.hoadon.application.dto;
...
/**
 * DTO for HoaDonAuditHistory entity.
 * Represents a single audit trail entry for order changes.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class HoaDonAuditHistoryDto implements Serializable {
