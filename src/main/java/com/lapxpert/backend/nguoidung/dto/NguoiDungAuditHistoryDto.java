...
/**
 * DTO for NguoiDungAuditHistory entity.
 * Represents a single audit trail entry for user changes.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class NguoiDungAuditHistoryDto implements Serializable {
